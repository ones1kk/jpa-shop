...
public class OrderQueryRepository {
    ...
    private List<OrderQueryDto> findOrders() {
        return em.createQuery("select " +
                "new jpabook.jpashop.repository.order.query.OrderQueryDto(o.id, m.name, o.orderDateTime, o.status, d.address) " +
                "from Order o " +
                "join o.member m " +
    ...
    public List<OrderFlatDto> findAllByDto_flat() {
        return em.createQuery("select " +
                ...
                "o.id, m.name, o.orderDateTime, o.status, d.address, i.name, oi.orderPrice, oi.count" +
                ") " +
                "from Order o " +
                "join o.member m " +
                "join o.delivery d " +
